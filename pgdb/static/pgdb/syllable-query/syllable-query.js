angular.module('syllableQuery', [
    ...
    .filter('secondsToDateTime', [function () {
    ...
    }]).controller('SyllableQueryCtrl', function ($scope, Syllables, Corpora, $state, $stateParams) {
        ...
        $scope.update = function () {
            Syllables.all($stateParams.corpus_id, $scope.offset, $scope.ordering, $scope.searchText).then(function (res) {
                console.log(res.data);
                $scope.count = res.data.count;
                $scope.numPages = Math.ceil($scope.count / $scope.resultsPerPage);
                $scope.syllables = res.data.results;
